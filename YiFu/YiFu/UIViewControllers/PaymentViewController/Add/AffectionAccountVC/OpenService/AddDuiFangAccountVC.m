...
@implementation AddDuiFangAccountVC
...
- (void)makeUI
{
    ...
    self.setUpPasswordTF.placeholder = @"输入对方账号";
    ...
    self.ResetUpPasswordTF.placeholder = @"修改备注";
    ...
    [_nextButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.beiZhuView.mas_bottom).offset(20);
        make.left.equalTo(self.beiZhuView.mas_left).offset(0);
        make.right.equalTo(self.beiZhuView.mas_right).offset(0);
...
{
    AddYiFuAccountVC *yifu = [AddYiFuAccountVC new];
    [self.navigationController pushViewController:yifu animated:YES];
}
@end
