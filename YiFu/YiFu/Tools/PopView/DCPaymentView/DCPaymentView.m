...
//        _paymentAlert = [[UIView alloc]initWithFrame:CGRectMake(40, [UIScreen mainScreen].bounds.size.height-KEYBOARD_HEIGHT-KEY_VIEW_DISTANCE-ALERT_HEIGHT, [UIScreen mainScreen].bounds.size.width-80, ALERT_HEIGHT)];
        _paymentAlert = [[UIView alloc]initWithFrame:CGRectMake(0,CoreHeight-350, CoreWidth, 350)];
        _paymentAlert.layer.cornerRadius = 5.f;
        _paymentAlert.layer.masksToBounds = YES;
        //_paymentAlert.backgroundColor = [UIColor grayColor];////
        _paymentAlert.backgroundColor = [UIColor colorWithWhite:1. alpha:.95];
        [self addSubview:_paymentAlert];
        
        _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(40, 0, PAYMENT_WIDTH, TITLE_HEIGHT)];
        ...
        _line = [[UILabel alloc]initWithFrame:CGRectMake(0, TITLE_HEIGHT, CoreWidth, .5f)];
        ...
        _detailLabel.textColor = [UIColor clearColor]; //darkGrayColor
//        _detailLabel.backgroundColor = [UIColor blueColor];///
        ...
        _amountLabel.textColor = [UIColor clearColor];//
...
//        _amountLabel.backgroundColor = [UIColor purpleColor];///
        ...
        _inputView = [[UIView alloc]initWithFrame:CGRectMake(55,70, CoreWidth-80-30, (PAYMENT_WIDTH-30)/6)];// _paymentAlert.frame.size.height-(PAYMENT_WIDTH-30)/6-15
//        _inputView.backgroundColor = [UIColor redColor];
        _inputView.layer.borderWidth = 0.5f;
        _inputView.layer.borderColor = KHexColor(@"#999999").CGColor;//[UIColor colorWithRed:.9 green:.9 blue:.9 alpha:1.].CGColor;
        ...
        for (int i = 0; i < PWD_COUNT; i ++) {
            ...
            line.backgroundColor = KHexColor(@"#909090");//[UIColor colorWithRed:.9 green:.9 blue:.9 alpha:1.];
